...
-- A credencial e empurrada pelo agente a cada ciclo (entity plugBoletoConfig);
-- os campos abaixo tambem aceitam preenchimento manual como override.
ALTER TABLE "TenantSettings"
  ...
  ADD COLUMN IF NOT EXISTS "plugBoletoConfigSyncedAt" TIMESTAMP(3);
