...
const { list, create, getQrCode, repair, recoverMessages, importContacts, importHistory, remove, healthEvents, updateServer } = require('../controllers/instanceController');
...
router.post('/:id/import-history', auditEvent('INSTANCE_IMPORT_HISTORY', 'instance'), importHistory);
