...
router.post('/', requirePermission('settings.bot.manage', 'settings.attendance.manage', 'settings.company.manage', 'settings.agent.manage', 'connections.manage', 'leads.manage', 'revenue.view'), filterSettingsAccess, auditSensitiveAction('SETTINGS_UPDATE', 'tenant_settings'), saveSettings);
...
router.post('/company/sync', requirePermission('settings.company.manage'), auditSensitiveAction('COMPANY_SYNC_REQUEST', 'tenant_settings'), syncCompanyFromFirebird);
...
router.post('/business-hours', requirePermission('settings.attendance.manage'), auditSensitiveAction('BUSINESS_HOURS_UPDATE', 'tenant_settings'), saveBusinessHours);
router.post('/logo', requirePermission('settings.company.manage'), upload.single('file'), auditSensitiveAction('COMPANY_LOGO_UPDATE', 'tenant_settings'), uploadLogo);
