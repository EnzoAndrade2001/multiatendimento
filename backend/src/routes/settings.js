...
const { getSettings, saveSettings, testAiProvider, syncCompanyFromIluxWeb, getSystemPromptPreview, getBusinessHours, saveBusinessHours, uploadLogo } = require('../controllers/settingsController');
...
router.post('/company/sync', requirePermission('settings.company.manage'), requireSupportAccess, auditSensitiveAction('COMPANY_SYNC_REQUEST', 'tenant_settings'), auditEvent('COMPANY_SYNC_REQUEST', 'tenant_settings'), syncCompanyFromIluxWeb);
