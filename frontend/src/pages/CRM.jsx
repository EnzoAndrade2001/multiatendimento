...
const s = {
  ...
  modalFooter: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: '0.75rem', padding: '0.85rem 1.4rem', borderTop: '1px solid var(--border-color)', background: 'var(--bg-panel)', color: 'var(--text-dim)', fontSize: '0.74rem' },
  ...
  quickActions: { display: 'flex', alignItems: 'center', flexWrap: 'wrap', gap: '0.55rem', padding: '0.8rem', borderRadius: 13, border: '1px solid var(--border-color)', background: 'var(--bg-panel)' },
  ...
  criticalAlert: { color: 'var(--danger-text)', background: 'var(--danger-light)', border: '1px solid var(--danger-border)' },
  ...
  metricDanger: { borderColor: 'var(--danger-border)', background: 'var(--danger-light)', color: 'var(--danger-text)' },
  stackedField: { display: 'grid', gap: 2, minWidth: 0, fontVariantNumeric: 'tabular-nums' },
  recurrenceBox: { display: 'flex', alignItems: 'center', gap: '0.65rem', marginTop: '0.7rem', padding: '0.7rem', color: 'var(--warning-text)', borderRadius: 10, background: 'var(--warning-light)' },
  ...
  infoSection: { padding: '1rem', border: '1px solid var(--border-color)', borderRadius: 15, background: 'var(--bg-panel)' },
