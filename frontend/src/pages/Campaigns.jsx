      ...
      {tab === 'compose' ? (
        <div style={s.layout}>
          <SurfaceCard style={s.card}>
            ...
            <div style={s.consentNotice}><CheckCircle2 size={17} /><span>O sistema remove duplicados, números inválidos e contatos sem consentimento para <strong>{typeInfo.label.toLowerCase()}</strong> antes do envio. Nada é enviado fora da categoria autorizada.</span></div>
