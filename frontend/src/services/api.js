...
export const getTechnicalContacts = () => api.get('/technical-contacts');
export const createTechnicalContact = (data) => api.post('/technical-contacts', data);
export const updateTechnicalContact = (id, data) => api.patch(`/technical-contacts/${id}`, data);
export const deleteTechnicalContact = (id) => api.delete(`/technical-contacts/${id}`);
